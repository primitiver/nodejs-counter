...
// "mentioned_mobile_list":["16603869908","15820874327","13532855589"]
  ...
  if(object_kind=='tag_push') {
    url='https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=e442ec4b-d0bc-44af-a9db-fa2d53688e0f'
    body=`{ 
      "msgtype": "text",
      "text":{
        "content": "${ref.includes('release')?'预生产环境':'生产环境更新'}\n更新时间：立刻更新\n发布人：${user_name}\n ${name}更新：\n${message}\n 版本：${ref.replace('refs/tags/',"")}",
        "mentioned_mobile_list":["16603869908","15820874327","13532855589"]
      }
    }`
